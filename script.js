...
function showTestimonial(index) {
  ...
  testimonials.forEach((item, i) => item.style.display = i === testIndex ? "block" : "");
}
$("#prevTest").addEventListener("click", () => showTestimonial(testIndex - 1));
$("#nextTest").addEventListener("click", () => showTestimonial(testIndex + 1));
